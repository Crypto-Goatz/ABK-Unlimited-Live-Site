...
export const LOCAL_DATA: Record<string, Record<string, string>[]> = {
  ...
  faqs: [
    ...
    { id: "faq-6", question: "How much does an outdoor firepit cost?", answer: "Custom stone firepits start around $5,000-$12,000. Gas fire pits run $6,000-$18,000 including gas line installation. Outdoor fireplaces range from $15,000-$40,000. Complete firepit packages with built-in seating walls start at $18,000. ABK Unlimited offers free on-site consultations.", category: "Outdoor Firepits" },
