/**
 * Pittsburgh Roofing Company — Local content data
...
export const LOCAL_DATA: Record<string, Record<string, string>[]> = {
  ...
  services: [
    {
      ...
      description: "Transform your kitchen into the heart of your home. From minor updates to complete renovations, Pittsburgh Roofing Company creates stunning, functional kitchens tailored to your lifestyle.",
    ...
    {
      id: "svc-hardscaping", title: "Hardscaping", slug: "hardscaping",
      description: "Transform your outdoor space with custom stone patios, retaining walls, walkways, and outdoor kitchens. Built to last through Pittsburgh's four seasons.",
      image_id: "", icon: "Layers", order: "5",
      features: "Stone Patios|Retaining Walls|Custom Walkways|Outdoor Kitchens|Seat Walls|Planters|Terracing|Drainage Solutions",
      price_range: "$10,000 - $80,000+",
    },
    {
      id: "svc-paving", title: "Paving", slug: "paving",
      description: "Professional paver installation for driveways, patios, walkways, and pool decks. Interlocking pavers, stamped concrete, and natural stone.",
      image_id: "", icon: "LayoutGrid", order: "6",
      features: "Paver Driveways|Stamped Concrete|Permeable Pavers|Pool Decks|Cobblestone Accents|Brick Paving|Commercial Paving|Repair & Restoration",
      price_range: "$8,000 - $60,000+",
    },
    {
      id: "svc-firepits", title: "Outdoor Firepits", slug: "outdoor-firepits",
      description: "Custom-built outdoor firepits and fireplaces that become the centerpiece of your backyard. Gas and wood-burning options with built-in seating.",
      image_id: "", icon: "Flame", order: "7",
      features: "Stone Firepits|Gas Fire Features|Outdoor Fireplaces|Built-In Seating|Fire Tables|Complete Patio Packages|Custom Designs|Lighting Integration",
  ...
  blog: [
    ...
    },
    {
      ...
      image_id: "", published_at: "2024-11-05", status: "published", author: "Pittsburgh Roofing Company Team", category: "Flooring", read_time: "5 min",
    },
  ],
  ...
  faqs: [
    { id: "faq-1", question: "How much does a stone patio cost in Pittsburgh?", answer: "In Pittsburgh, a professional stone patio installation typically costs $15-$35 per square foot depending on materials. A 300 sq ft flagstone patio averages $8,000-$12,000 installed. Travertine and bluestone run higher. Pittsburgh Roofing Company provides free detailed estimates with no obligation.", category: "Hardscaping" },
    { id: "faq-2", question: "How much does a paver driveway cost?", answer: "A paver driveway in Pittsburgh typically costs $12-$25 per square foot for interlocking concrete pavers, or $20-$45 per square foot for natural stone. For an average 600 sq ft driveway, expect $7,200-$15,000 for concrete pavers or $12,000-$27,000 for natural stone, fully installed.", category: "Paving" },
    { id: "faq-3", question: "Gas or wood-burning firepit — which is better?", answer: "Gas firepits offer push-button convenience with no smoke, sparks, or cleanup. Wood-burning gives you the traditional crackling fire and campfire aroma. Gas is safer for covered areas. Many Pittsburgh homeowners choose gas for primary use and add a small wood-burning option nearby.", category: "Outdoor Firepits" },
    { id: "faq-4", question: "Do I need a permit for hardscaping in Pittsburgh?", answer: "Retaining walls over 4 feet typically require a building permit in Pittsburgh-area municipalities. Standard patios and walkways usually don't. Gas firepit installations need plumbing permits. Pittsburgh Roofing Company handles all permitting as part of every project.", category: "Hardscaping" },
    { id: "faq-5", question: "How long does a paver installation take?", answer: "A standard paver driveway takes 3-5 days. Patios and walkways typically take 2-4 days. Larger projects with complex patterns may take 1-2 weeks. Hardscaping projects like retaining walls and outdoor kitchens take 1-3 weeks depending on scope.", category: "Paving" },
    { id: "faq-6", question: "How much does an outdoor firepit cost?", answer: "Custom stone firepits start around $5,000-$12,000. Gas fire pits run $6,000-$18,000 including gas line installation. Outdoor fireplaces range from $15,000-$40,000. Complete firepit packages with built-in seating walls start at $18,000. Pittsburgh Roofing Company offers free on-site consultations.", category: "Outdoor Firepits" },
    ...
    { id: "faq-12", question: "Do I need permits for remodeling in Pittsburgh?", answer: "Most significant remodeling projects in Pittsburgh require permits. This includes structural changes, electrical work, plumbing modifications, and additions. Pittsburgh Roofing Company handles all permit applications and inspections as part of our service.", category: "Remodeling" },
  ],

  seo: [
    { page_path: "/", title: "Pittsburgh Roofing Company | Pittsburgh's Trusted General Contractor | Kitchen & Bath Remodeling", description: "Award-winning Pittsburgh general contractor specializing in kitchen remodeling, bathroom renovations, basement finishing & deck building. Licensed & insured. Free estimates. Call (412) 944-1683.", og_image_id: "" },
    { page_path: "/about", title: "About Pittsburgh Roofing Company | Pittsburgh General Contractor | Licensed & Insured", description: "Pittsburgh Roofing Company is a family-owned general contractor serving Greater Pittsburgh. PA Licensed (HIC #PA163301), BBB A+ Rated, Best of Houzz 2025. Kitchen, bathroom, basement, and whole-home remodeling.", og_image_id: "" },
    { page_path: "/services", title: "Our Services | Pittsburgh Roofing Company Pittsburgh General Contractor", description: "Comprehensive home remodeling services in Pittsburgh. Kitchen & bathroom remodeling, basement finishing, deck building, home additions, flooring, custom homes & commercial construction.", og_image_id: "" },
    { page_path: "/portfolio", title: "Portfolio | Pittsburgh Roofing Company Pittsburgh General Contractor", description: "View our portfolio of completed projects. Kitchen remodels, bathroom renovations, basement finishing, decks & more.", og_image_id: "" },
    { page_path: "/testimonials", title: "Customer Reviews & Testimonials | Pittsburgh Roofing Company Pittsburgh Contractor", description: "Read verified reviews from Pittsburgh homeowners. See why Pittsburgh Roofing Company is rated 5 stars.", og_image_id: "" },
    { page_path: "/blog", title: "Blog | Pittsburgh Roofing Company Pittsburgh Home Remodeling Tips & Ideas", description: "Expert home remodeling tips, design ideas, and advice from Pittsburgh Roofing Company.", og_image_id: "" },
    { page_path: "/contact", title: "Contact Pittsburgh Roofing Company | Pittsburgh General Contractor", description: "Contact Pittsburgh Roofing Company for your home remodeling project. Call (412) 944-1683 or fill out our form for a free estimate.", og_image_id: "" },
  ],
